...
<head>
    ...
    <meta name="keywords" content="Page de choix de personnage parmi les chevaliers" />
    ...
    <main class="container">
        <div class="card-detail">
            ...
            if ($card) {
                ...
                echo '<button type="button" class="accordion" aria-expanded="false" aria-controls="panel-mythology">Histoire</button>';
                echo '<div class="panel" id="panel-mythology">';
