            ...
            <form class="login_cont" action="register.php" method="post">
              <div class="input_signup active">
                ...
                <input class="input input_form" id="user_name" type="text" name="login"
                  aria-label="Nom d’utilisateur (contient des lettres/chiffres)"
                ...
                <input class="input input_form" id="user_email" type="email" name="email" aria-label="Adresse e-mail"
                  placeholder="Email">
                ...
                <input class="input input_form" id="repassword" type="password" name="repasswd"
                  aria-label="Confirmer le mot de passe" placeholder="Mdp/Password">
                ...
                <div class="content">
                  <p>Pour télécharger le client du jeu, <br>vous devez vous creer un compte</p>
                </div>
              </div>
            </form>
          </div>
